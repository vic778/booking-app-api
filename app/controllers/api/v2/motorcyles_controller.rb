class Api::V2::MotorcylesController < ApplicationController
    ...
    def create
        ...
        if @motorcycle.save
            render json: {success: true, message: "Motorcycle created successfully", motorcycle: @motorcycle}, status: :created
        else
            render json: {success: false, message: "Motorcycle not created", errors: @motorcycle.errors}, status: :bad_request
        end
    end
    ...
    def update
        ...
        if @motorcycle.update(motorcycle_params)
            render json: {success: true, message: "Motorcycle updated successfully", motorcycle: @motorcycle}, status: :ok
        else
            render json: {success: false, message: "Motorcycle not updated", errors: @motorcycle.errors}, status: :bad_request
        end
    end
